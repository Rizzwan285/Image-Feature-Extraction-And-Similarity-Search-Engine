//displaying query selection panel component
import { useState, useRef } from 'react'

import { motion, AnimatePresence } from 'framer-motion'

import { Upload, Image as ImageIcon, Search, X, GitCompare } from 'lucide-react'
                  ...
                  <div className="flex flex-wrap items-center gap-3">
                    ...
                    {onCompare && (
                      <motion.button
                        ...
                        onClick={onCompare}
                        disabled={isSearching}
                        className="px-5 py-3 rounded-xl font-medium text-white/90 bg-white/5 hover:bg-white/10 border border-white/10 hover:border-accent-400/40 disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center gap-2"
                      >
                        <GitCompare size={16} />
